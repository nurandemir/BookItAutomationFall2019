...
public class APIUtilities {
     ...
     */
    //if user not exist it will fail, that's why we put it in try catch
    //method supposed to return user id based on credentials of its user, if you are trying to sign in as user that
    // doesn't exist method returns -1
